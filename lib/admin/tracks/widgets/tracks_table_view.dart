...
class AdminTracksTableView extends ConsumerWidget {
  const AdminTracksTableView({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final provider = adminTracksNotifierProvider;
                          ...
                          rows: state.pageResults.map((e) {
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(Text(e.artistsLabel(ref, lang))),

...
class AdminPlaylistsView extends HookConsumerWidget {
  const AdminPlaylistsView({super.key, required this.playlists, this.onRemove});

  final List<Playlist> playlists;

  final Function(Playlist playlist)? onRemove;
            ...
            children: results
                .map(
                  (e) => ListTile(
                    ...
                    subtitle: Text("${e.tracks.length} tracks"),

...
class MusicCategoryAdapter extends TypeAdapter<MusicCategory> {
  @override
  final int typeId = 2;

  @override
  MusicCategory read(BinaryReader reader) {
    ...
    return MusicCategory(
      ...
      updatedBy: fields[13] as int?,
    );
  }

  @override
  void write(BinaryWriter writer, MusicCategory obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)

...
import 'package:avahan/features/location/providers/states_provider.dart';
import 'package:avahan/utils/extensions.dart';
import 'package:flutter/material.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

class SearchStateDelegate extends SearchDelegate<LocObj?> {
  final String ciso;

  SearchStateDelegate(this.ciso);
  @override
  ...
  Widget view(BuildContext context) {
    return HookConsumer(
      builder: (context, ref, child) {
        return AsyncWidget(
          value: ref.watch(statesProvider(ciso)),
          data: (countries) {
